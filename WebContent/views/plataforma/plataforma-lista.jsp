		...
		<tbody>
			...
			<c:forEach var="listas" items="${listaPlataforma.plataformaLista()}">
				<tr>
					...
					<td><a class="btn btn btn-mini btn-danger " href="?views=game/game-cadastro" rel="tooltip" data-placement="top" title="Excluir Registro"><i class="icon-remove-sign"></i></a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
